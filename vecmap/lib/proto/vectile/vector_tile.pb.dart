...
//  source: vectile/vector_tile.proto
//
// @dart = 2.12
...
class Tile_Value extends $pb.GeneratedMessage {
  ...
  Tile_Value copyWith(void Function(Tile_Value) updates) =>
      super.copyWith((message) => updates(message as Tile_Value)) as Tile_Value;
...
class Tile_Feature extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'Tile.Feature',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'vector_tile'),
      createEmptyInstance: create)
    ..a<$fixnum.Int64>(1, _omitFieldNames ? '' : 'id', $pb.PbFieldType.OU6,
        defaultOrMaker: $fixnum.Int64.ZERO)
    ..p<$core.int>(2, _omitFieldNames ? '' : 'tags', $pb.PbFieldType.KU3)
    ..e<Tile_GeomType>(3, _omitFieldNames ? '' : 'type', $pb.PbFieldType.OE,
...
class Tile_Layer extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'Tile.Layer',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'vector_tile'),
      createEmptyInstance: create)
    ..aQS(1, _omitFieldNames ? '' : 'name')
    ..pc<Tile_Feature>(2, _omitFieldNames ? '' : 'features', $pb.PbFieldType.PM,
        subBuilder: Tile_Feature.create)
    ..pPS(3, _omitFieldNames ? '' : 'keys')
    ..pc<Tile_Value>(4, _omitFieldNames ? '' : 'values', $pb.PbFieldType.PM,
        subBuilder: Tile_Value.create)
    ..a<$core.int>(5, _omitFieldNames ? '' : 'extent', $pb.PbFieldType.OU3,
        defaultOrMaker: 4096)
    ..a<$core.int>(15, _omitFieldNames ? '' : 'version', $pb.PbFieldType.QU3,
        defaultOrMaker: 1)
    ..hasExtensions = true;
  ...
  Tile_Layer copyWith(void Function(Tile_Layer) updates) =>
      super.copyWith((message) => updates(message as Tile_Layer)) as Tile_Layer;
...
class Tile extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'Tile',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'vector_tile'),
      createEmptyInstance: create)
    ..pc<Tile_Layer>(3, _omitFieldNames ? '' : 'layers', $pb.PbFieldType.PM,
  ...
  Tile copyWith(void Function(Tile) updates) =>
      super.copyWith((message) => updates(message as Tile)) as Tile;
